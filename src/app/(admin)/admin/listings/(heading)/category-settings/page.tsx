  ...
  return (
    <div className="p-4 sm:p-6 md:p-8 bg-gray-50 min-h-screen">
      <div className="max-w-4xl mx-auto bg-white p-4 sm:p-6 md:p-8 rounded-lg shadow-md">
        <h1 className="text-xl sm:text-2xl font-bold mb-2 text-gray-800">검색창 표시 설정</h1>
        <p className="text-sm sm:text-base text-gray-600 mb-6 sm:mb-8">사용자 페이지에 표시될 검색 필터를 선택하세요.</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
          {Object.keys(settingLabels).map((key) => (
            ...
            >
              <span className="font-medium text-gray-700 text-sm sm:text-base">{settingLabels[key]}</span>
        ...
        <div className="mt-6 sm:mt-8 flex justify-end">
          <button
            ...
            className="w-full sm:w-auto px-6 py-2 bg-blue-600 text-white font-semibold rounded-lg shadow-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-75 disabled:bg-gray-400 disabled:cursor-not-allowed"
          >
